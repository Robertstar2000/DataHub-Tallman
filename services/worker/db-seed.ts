...
import type { Workflow, McpServer, User, WidgetConfig } from '../../types';

// We use 'any' for the db instance to avoid importing types from 'sql.js'
// which can cause module resolution errors in the worker context.
export function populateDatabase(db: any) {
    ...
    const initialUsers: User[] = [ 
        { id: 1, name: 'Robert Star', email: 'Robertstar@aol.com', role: 'Admin' }, 
